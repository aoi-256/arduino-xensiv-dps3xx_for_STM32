...
public:
    ...
    /**
    * STM32 HAL_I2C begin function with standard address
    */
    void begin(I2C_HandleTypeDef* use_i2c_pin);

    /**
     * STM32 HAL_SPI begin function with standard address
     */
    void begin(SPI_HandleTypeDef* use_spi_pin, GPIO_TypeDef* cs_pin_type, uint16_t use_cs_pin);
...
protected:
    ...
    uint8_t i2c_slave_address = 0x76 << 1;
